...
Q1='Проанализируй модель со значениями метанола 2025 (450, 500) с шагом 5 и инфляции USD CPI 2025 (0,1 , 0,2) с шагом 0,1. Покажи изменения debt/ebitda, net debt/ebitda (ltm) и icr corr (ltm) 2025.'

Q2='Скажи, при каких значениях цены метанола и роста потребительских цен США в модели значение ebitda 2026 будет 1000?'

Q3='Какой вывод можно сделать по полседнему рассчету?'
